...
const contractABI = require("../artifacts/contracts/Pixelledger.sol/Pixelledger.json").abi;

program
    .name("pixelledger-cli")
    .description("CLI tool for Pixelledger smart contract")
    .version("1.0.0");
